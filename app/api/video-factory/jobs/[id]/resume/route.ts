...
/**
 * POST /api/video-factory/jobs/[id]/resume
 * Proxy tới Server B: POST /api/v1/video-factory/jobs/:id/resume
 */
export async function POST(
  ...
  try {
    ...
    const res = await fetch(`${SERVER_B_URL}/api/v1/video-factory/jobs/${jobId}/resume`, {
      method: "POST",
      headers: {
    ...
    console.error("POST /api/video-factory/jobs/[id]/resume error:", err);
