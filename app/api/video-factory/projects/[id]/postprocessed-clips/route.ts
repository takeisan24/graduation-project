/**
 * Server A Proxy: GET /api/video-factory/projects/:id/postprocessed-clips
 * 
 * Proxy to Server B GET /v1/video-factory/projects/:projectId/postprocessed-clips
 * Returns postprocessed clips grouped by postprocess job for a project
 */
...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      const res = await fetch(`${SERVER_B_URL}/api/v1/video-factory/projects/${projectId}/postprocessed-clips`, {
        method: 'GET',
        headers: {
    ...
    console.error('[GET /api/video-factory/projects/:id/postprocessed-clips] Error:', error);
    return NextResponse.json(
      {
        success: false,
