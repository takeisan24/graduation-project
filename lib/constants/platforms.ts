...
export const PLATFORM_DISPLAY_MAP: Record<string, {
  ...
  x:         { name: 'X', icon: '/icons/platforms/x.png',        color: 'bg-black',       invert: true },
  twitter:   { name: 'X', icon: '/icons/platforms/x.png',        color: 'bg-black',       invert: true },
...
/**
 * SOCIAL_PLATFORMS — deduplicated ordered list for UI surfaces
 * Keep a single canonical entry for X/Twitter to avoid duplicate chips/icons.
 */
export const SOCIAL_PLATFORMS = [
  PLATFORM_DISPLAY_MAP.tiktok,
  PLATFORM_DISPLAY_MAP.instagram,
  PLATFORM_DISPLAY_MAP.youtube,
  PLATFORM_DISPLAY_MAP.facebook,
  PLATFORM_DISPLAY_MAP.x,
  PLATFORM_DISPLAY_MAP.threads,
  PLATFORM_DISPLAY_MAP.linkedin,
  PLATFORM_DISPLAY_MAP.pinterest,
];
