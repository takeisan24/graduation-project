  ...
  return (
    ...
    <div className="sticky bottom-0 left-0 right-0 bg-muted flex flex-col">
      ...
      <div className="flex flex-col gap-2 px-3 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {showGenerateMenu && (
            ...
            >
              ...
              {/* Sinh video tạm ẩn trong bản hiện tại: endpoint /api/ai/generate-video chưa triển khai. Bật lại bằng env NEXT_PUBLIC_ENABLE_VIDEO_GEN=true. */}
              ...
              {/* Media Library tạm ẩn trong bản hiện tại: phụ thuộc Server B (S3) chưa cấu hình. Bật lại bằng env NEXT_PUBLIC_ENABLE_MEDIA_UPLOAD=true. */}
        ...
        {/* C-1: Separator */}
        <div className="hidden sm:block w-px h-6 bg-border mx-1 flex-shrink-0" />
        ...
        <div className="flex flex-wrap items-center gap-2 sm:justify-end">
          ...
          <Button
            data-testid="open-publish-modal-button"
