  ...
  return (
    <div className="w-full h-full relative z-0 flex flex-col scroll-smooth" style={{ scrollPaddingBottom: 'env(keyboard-inset-height, 16px)' }} data-tour="ai-chat">
      <div className="flex-1 min-h-0 flex flex-col">
              ...
              <div className="max-w-sm space-y-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <button
                    ...
                    className="w-full text-left p-2 rounded-lg bg-background border border-border/50 hover:border-purple-500/30 hover:bg-secondary transition-all group"
                  >
                  ...
                  <button
                    ...
                    className="w-full text-left p-2 rounded-lg bg-background border border-border/50 hover:border-blue-500/30 hover:bg-secondary transition-all group"
                  >
                    <div className="flex items-start gap-2">
                  ...
                  <button
                    ...
                    className="w-full text-left p-2 rounded-lg bg-background border border-border/50 hover:border-green-500/30 hover:bg-secondary transition-all group"
                  >
                    <div className="flex items-start gap-2">
        ...
        <div className="border-t border-border/50 p-2 bg-background flex-shrink-0">
