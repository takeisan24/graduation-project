...
export default function AIChatbox() {
  ...
  return (
    <div className="w-full h-full border-l border-border p-[15px] relative z-0 flex flex-col" data-tour="ai-chat">
      <Card className="bg-card border-border flex-1 min-h-0 flex flex-col p-0 gap-0 rounded-[5px]">
        {/* Model Selector Header with New Chat Button */}
        <div className="h-[50px] border-b border-border flex items-center justify-between pt-4 px-2 bg-muted flex-shrink-0">
          <div className="relative -mt-[15px]" ref={modelMenuRef}>
            <button
              type="button"
              onClick={() => setShowModelMenu((v) => !v)}
              className="inline-flex items-center gap-2 text-sm font-semibold leading-none text-foreground/90 hover:text-foreground"
            >
            ...
            {showModelMenu && (
              <div className="absolute mt-2 w-56 bg-card border border-border rounded-md shadow-[0_0_0_1px_rgba(255,255,255,0.08)] py-2 z-20">
                {modelOptions.map((model) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 text-sm hover:bg-secondary ${selectedChatModel === model ? 'text-foreground' : 'text-foreground/80'
                      }`}
                  >
                    {model}
                  </button>
          ...
          <button
            ...
            className="-mt-[15px] p-1.5 rounded-lg bg-secondary hover:bg-secondary/80 text-muted-foreground hover:text-foreground transition-all group"
              ...
              <div className="max-w-sm space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full text-left p-2.5 rounded-lg bg-background border border-border/50 hover:border-purple-500/30 hover:bg-secondary transition-all group"
                  >
                  ...
                  <button
                    ...
                    className="w-full text-left p-2.5 rounded-lg bg-background border border-border/50 hover:border-blue-500/30 hover:bg-secondary transition-all group"
                  >
                    <div className="flex items-start gap-2">
                  ...
                  <button
                    ...
                    className="w-full text-left p-2.5 rounded-lg bg-background border border-border/50 hover:border-green-500/30 hover:bg-secondary transition-all group"
                  >
                    <div className="flex items-start gap-2">
