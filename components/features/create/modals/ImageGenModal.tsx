...
import { useImageGenModalStore, useCreatePostsStore, useCreateLightboxStore, useCreateMediaStore } from '@/store';
...
export default function ImageGenModal() {
  ...
  }, [isOpen, selectedPostId, postContents, source]);
        ...
        <div className="px-6 py-4 border-t border-border flex items-center justify-between bg-background/30">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              ...
              <span className="text-muted-foreground text-sm">{t('imagesUnit')}</span>
            </div>
          </div>
