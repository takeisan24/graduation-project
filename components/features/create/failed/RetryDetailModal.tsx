  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div className="bg-[#1E1E23] border border-white/10 rounded-2xl w-[600px] max-w-[95vw] shadow-xl max-h-[90vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-6 py-5 overflow-y-auto">
          <div className="flex items-center gap-3 mb-4 pb-4 border-b border-white/10">
            ...
            <div className="flex-1">
              ...
              <div className="text-white/60 text-sm">{account.username}</div>
            </div>
          ...
          <div className="bg-[#7E1C39]/30 border border-[#E33265]/40 rounded-xl p-5 mb-5">
            ...
            <div className="text-white text-base leading-6">{reason.message}</div>
            {post.errorMessage && (
              <div className="mt-3 text-sm text-white/80 leading-6">
                <span className="font-semibold text-white">Chi tiết từ nền tảng:</span> {post.errorMessage}
              </div>
            )}
          </div>
          {isContentIssue ? (
        ...
        {!isContentIssue && (
          <div className="px-6 pb-6 flex items-center justify-between gap-4 border-t border-white/10 pt-4 mt-auto">
