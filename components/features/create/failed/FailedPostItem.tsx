      ...
      <div className="flex items-center px-4 py-3 w-full">
        ...
        <div className="flex flex-col items-start text-foreground/80 flex-shrink-0 ml-4" style={{ width: `${maxWidth}px` }}>
          <div className="flex items-center gap-2 mb-1 w-full">
            <div className="w-5 h-5 rounded-full overflow-hidden flex-shrink-0">
              <Image unoptimized src={account.profilePic} alt="Profile" width={20} height={20} className="w-full h-full object-cover" />
            </div>
        ...
        <div className="flex items-center gap-2 flex-shrink-0 ml-4">
          ...
          <button
            ...
            aria-label={t('delete')}
          >
            <Image unoptimized src="/icons/sidebar/Trash.svg" alt="Delete" width={19} height={19} className="opacity-80" />
          </button>
        </div>
      </div>
    </div>
