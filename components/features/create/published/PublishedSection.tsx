        ...
        <div className="space-y-[1px] pb-4">
          {filteredPosts && filteredPosts.length > 0 ? (
            filteredPosts.map((post) => (
              <div 
                key={post.id} 
                className="group rounded-xl bg-[#1C1C21] hover:bg-[#25252b] transition-colors border border-white/5 p-3 lg:p-4 mb-2 cursor-pointer flex flex-col sm:flex-row gap-3"
              ...
              >
                ...
                <div className="flex-1 min-w-0 flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                     <p className="text-sm lg:text-base text-white/90 line-clamp-2 mb-2">
                       {post.content}
                     </p>
                     
                     {/* Mobile Engagement Stats (visible on small screens) */}
                     <div className="flex sm:hidden items-center gap-4 text-xs text-white/50 mb-1">
                     ...
                     <div className="flex items-center gap-2 text-xs text-white/40">
                       ...
                       {post.url && (
                         <span className="flex items-center gap-1 hover:text-[#E33265] transition-colors">
                ...
                <div className="hidden sm:flex flex-col items-end gap-2 text-right pl-2 border-l border-white/5 min-w-[100px]">
