          ...
          >
            {duplicatedPlatforms.map((platform, index) => (
              <div
                ...
                className="flex items-center justify-center shrink-0 p-2 opacity-60 hover:opacity-100 hover:scale-110 hover:rotate-6 transition-all duration-300 cursor-pointer"
                title={platform.name}
                style={{
